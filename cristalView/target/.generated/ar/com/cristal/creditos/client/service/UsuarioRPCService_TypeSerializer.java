...
public class UsuarioRPCService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static Map<String, TypeHandler> loadMethodsJava() {
    ...
    result.put("ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto/286813212", new ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto_FieldSerializer.Handler());
    result.put("[Lar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto;/2412772558", new ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto_Array_Rank_1_FieldSerializer.Handler());
  ...
  private static native MethodMap loadMethodsNative() /*-{
    var result = {};
    result["ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto/286813212"] = [
        @ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lar/com/cristal/creditos/client/accesibilidad/ComponenteDePantallaDto;),
      ];
    
    result["[Lar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto;/2412772558"] = [
        @ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lar/com/cristal/creditos/client/accesibilidad/ComponenteDePantallaDto;),
      ];
    ...
    result["ar.com.cristal.creditos.client.accesibilidad.PerfilesDto/1382345195"] = [
        ...
        @ar.com.cristal.creditos.client.accesibilidad.PerfilesDto_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lar/com/cristal/creditos/client/accesibilidad/PerfilesDto;)
      ];
    ...
    result["ar.com.cristal.creditos.client.ui.usuarios.dto.UsuarioDTO/3852725950"] = [
        ...
        @ar.com.cristal.creditos.client.ui.usuarios.dto.UsuarioDTO_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lar/com/cristal/creditos/client/ui/usuarios/dto/UsuarioDTO;)
      ];
  ...
  private static Map<Class<?>, String> loadSignaturesJava() {
    ...
    result.put(ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto_FieldSerializer.concreteType(), "ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto/286813212");
    result.put(ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto_Array_Rank_1_FieldSerializer.concreteType(), "[Lar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto;/2412772558");
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    var result = [];
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto::class)] = "ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto/286813212";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@ar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto[]::class)] = "[Lar.com.cristal.creditos.client.accesibilidad.ComponenteDePantallaDto;/2412772558";
  ...
  public UsuarioRPCService_TypeSerializer() {
