 ...
 */
public class BusquedaClientesPlace extends Place {
	...
	public BusquedaClientesPlace(String token) {
		this.name = token;
	}
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<BusquedaClientesPlace> {

		public String getToken(BusquedaClientesPlace place) {
			return place.getName();
		}

		public BusquedaClientesPlace getPlace(String token) {
			return new BusquedaClientesPlace(token);
		}
