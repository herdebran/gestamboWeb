 ...
 */
public class SeleccionReportePlace extends Place {
	...
	public SeleccionReportePlace(String token) {
		this.name = token;
	}
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<SeleccionReportePlace> {

		public String getToken(SeleccionReportePlace place) {
			return place.getName();
		}

		public SeleccionReportePlace getPlace(String token) {
			return new SeleccionReportePlace(token);
		}
