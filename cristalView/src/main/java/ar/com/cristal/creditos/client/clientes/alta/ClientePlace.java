 ...
 */
public class ClientePlace extends Place {
	...
	public ClientePlace(String token) {
		this.name = token;
	}
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<ClientePlace> {

		public String getToken(ClientePlace place) {
			return place.getName();
		}

		public ClientePlace getPlace(String token) {
			return new ClientePlace(token);
		}
