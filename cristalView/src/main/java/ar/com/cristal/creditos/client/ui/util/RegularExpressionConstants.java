...
public class RegularExpressionConstants {
	...
	/** importe de 8 digitos y 2 decimales */
	public static final String importeSeparadorDecimalPunto = "^([0-9]{0,7}|[0-9]{0,7}\\.|[0-9]{0,7}\\.[0-9]{0,2})$";

	public static final String caracter = "[^0-9]";

	public static final String letras = "[A-Za-z\\sñÑ'áéíóúÁÉÍÓÚ]+";
	...
	/** Validacion sencilla para controlar passwords (letras, números y punto */
	public static final String password(int cant) {
		return "(?:[\\.a-zA-Z0-9_\'^&amp;/+-]+)*{0," + cant + "}";
	}
	
	public static final String numeroLetrasEspacioGuion = "[0-9|\\-|A-Za-z\\sñÑ'áéíóúÁÉÍÓÚ|\\_| ]*";
}
