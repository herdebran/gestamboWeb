...
public class BusquedaRodeosView extends Composite  {
	...
	private static BusquedaRodeosViewUiBinder uiBinder = GWT
			.create(BusquedaRodeosViewUiBinder.class);

	interface BusquedaRodeosViewUiBinder extends
			UiBinder<Widget, BusquedaRodeosView> {
	}

	public BusquedaRodeosView() {
	...
	public void initTable(){
		...
		detalle.setText(0, 2,"Tipo");
	}
	

	public BusquedaRodeosView(String firstName) {
		initWidget(uiBinder.createAndBindUi(this));
	}
	
	public String getRodeoBusqueda(){
		return getText(rodeoBusqueda.getText());
	}
