 ...
 */
public class ListadoUsuariosPlace extends Place {
	...
	public ListadoUsuariosPlace(String token) {
		this.name = token;
	}
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<ListadoUsuariosPlace> {

		public String getToken(ListadoUsuariosPlace place) {
			return place.getName();
		}

		public ListadoUsuariosPlace getPlace(String token) {
			return new ListadoUsuariosPlace(token);
		}
