...
public abstract class NumberToLetterConverter {
	...
	public static String convertNumberToLetter(double number)
		...
		//Agrego espacio antes de PESOS
		converted += " PESOS";
 
		// Descompone los centavos: Arreglado por Hernan.
		if (splitNumber[1].length()==1){
			switch (Integer.valueOf(splitNumber[1])){
			case 0:
				break;
			case 1:
				converted += " CON DIEZ CENTAVOS";
				break;
			case 2:
				converted += " CON VEINTE CENTAVOS";
				break;
			case 3:
				converted += " CON TREINTA CENTAVO";
				break;
			case 4:
				converted += " CON CUARENTA CENTAVOS";
				break;
			case 5:
				converted += " CON CINCUENTA CENTAVO";
				break;
			case 6:
				converted += " CON SESENTA CENTAVOS";
				break;
			case 7:
				converted += " CON SETENTA CENTAVOS";
				break;
			case 8:
				converted += " CON OCHENTA CENTAVOS";
				break;
			case 9:
				converted += " CON NOVENTA CENTAVOS";
				break;
			}
		}else{
